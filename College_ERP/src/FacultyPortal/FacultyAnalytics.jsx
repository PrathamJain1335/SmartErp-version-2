...
const studentsData = [
  // [Data remains unchanged, as provided]
  {
    ...
    profileImage: 'https://via.placeholder.com/100x100?text=AS',
    performance: {
      currentGPA: 8.7,
    ...
    <div className="faculty-card p-4 mb-6">
        ...
        <div className="w-full lg:w-80">
          ...
          <select
            ...
            className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 text-sm lg:text-base"
            style={{ backgroundColor: 'var(--card)', color: 'var(--text)' }}
          >
        ...
        <>
          ...
          {activeView === 'overview' && (
            <div className="space-y-6">
              {/* First row - GPA Progress and Performance Distribution */}
                  ...
                  <div className="h-64 lg:h-80">
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        <Pie
                          data={[
                            { name: 'Excellent (90-100)', value: 35, color: 'var(--chart-color-3)' },
                            { name: 'Good (80-89)', value: 40, color: 'var(--chart-color-1)' },
                            { name: 'Average (70-79)', value: 20, color: 'var(--chart-color-4)' },
                            { name: 'Below Average (<70)', value: 5, color: 'var(--chart-color-5)' }
                          ]}
                          dataKey="value"
                          nameKey="name"
                          cx="50%"
              ...
              {/* Second row - Attendance Trend and Approval Status Distribution */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* Attendance Trend */}
                <div className="faculty-card p-6">
                  <h3 className="text-xl font-bold mb-4" style={{ color: 'var(--text-primary)' }}>
                  ...
                  <div className="h-80">
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        <Pie
                          data={[
                            { name: 'Approved', value: 65, color: 'var(--chart-color-3)' },
                            { name: 'Pending', value: 25, color: 'var(--chart-color-4)' },
                            { name: 'Under Review', value: 8, color: 'var(--chart-color-1)' },
                            { name: 'Rejected', value: 2, color: 'var(--chart-color-5)' }
                          ]}
                          dataKey="value"
                          nameKey="name"
                          cx="50%"
              ...
              {/* Third row - Overall Grade Distribution */}
              <div className="faculty-card p-6">
                <h3 className="text-xl font-bold mb-4" style={{ color: 'var(--text-primary)' }}>
                ...
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      />
                      <Bar dataKey="count" fill="var(--chart-color-1)" radius={[4, 4, 0, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              </div>
                ...
                <div className="h-80">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={coursesPerformanceData}>
                      ...
                      />
                      <Bar dataKey="marks" fill="#dc2626" radius={[4, 4, 0, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              </div>
